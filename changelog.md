...
- Anchored the mobile chat mass-delete dialog below device safe areas with scrollable narrow-screen padding so the title, age filter, presets, and delete actions stay reachable.
