 ...
 * @property {string} inChatAgents - The directory where the in-chat agents are stored
 * @property {string} inChatAgentGroups - The directory where the in-chat agent groups are stored
 */
...
export async function verifySecuritySettings() {
    ...
    if (!ENABLE_ACCOUNTS) {
        logSecurityAlert('Your current SillyBunny configuration is insecure (listening to non-localhost). Enable whitelisting, basic authentication or user accounts.');
    }
